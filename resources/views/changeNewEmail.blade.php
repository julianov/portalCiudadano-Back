        ...
        <table style="width: 100%; border: none; border-collapse: collapse;">
            <tr>
                <td style="padding: 20px;"> 
                    ...
                    <p style="font-size: 1rem;">PARA CAMBIAR EL EMAIL PRESIONE EL SIGUIENTE ENLACE</p>
                    <br>
                    <a id="btn_cambiar_pass" href="{{'https://sistemasdesa.entrerios.gov.ar/cdig/html/ciudadanoDigital_Front/build/dashboard/configurations/email/change/validate/?token=' . $mixto  }}">
