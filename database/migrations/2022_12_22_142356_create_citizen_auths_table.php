...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ciudadano_autenticacion', function (Blueprint $table) {
            ...
            $table->foreignIdFor(\App\Models\Citizen::class, "ciudadano_id")->constrained()->cascadeOnDelete(); # Id de la tabla ciudadano
            $table->foreignIdFor(\App\Models\AuthType::class, "autenticacion_tipo_id")->constrained()->cascadeOnDelete(); # Id de la tabla AUTENTICACION_TIPO
